...
searchButton.addEventListener('click', (e) => {
    ...
    const url = `https://api.spotify.com/v1/search?q=${searchText}&type=track&market=IN&limit=7&offset=5`
    const xhr = new XMLHttpRequest();
    xhr.open("GET", url);

    xhr.setRequestHeader("Authorization", "BQDvtMsjRjmXB1a5B9RFOdMZPBJ97DQ0HfNdHUali-zhThAKsgMXSnpb6JjFT-FiLvD1BhFbDCcZNaZx-vs")
